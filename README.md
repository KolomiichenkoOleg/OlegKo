...
В этом репозитории вы можете нрайти некоторые из моих проектов.
...
2.3 Провести различные виды тестирования;

2.4 Написать отчет о результатах тестирования.
...
5.1 Составлен полный комплект тестовой документации);

5.2 Проведено успешное тестирование;

5.3 Проведен анализ и даны рекомендации;

5.4 Получен опыт исследовательского тестирования и работы в команде.
